...
namespace {
template <typename T>
void DeclareAndGet(rclcpp::Node &node, const std::string &name, T &value, const T &default_value)
{
...
{
    DeclareAndGet<double>(node, "dyn_obj/buffer_delay", buffer_delay, 0.1);
    DeclareAndGet<int>(node, "dyn_obj/buffer_size", buffer_size, 300000);
    DeclareAndGet<int>(node, "dyn_obj/points_num_perframe", points_num_perframe, 150000);
    DeclareAndGet<double>(node, "dyn_obj/depth_map_dur", depth_map_dur, 0.2);
    DeclareAndGet<int>(node, "dyn_obj/max_depth_map_num", max_depth_map_num, 5);
    DeclareAndGet<int>(node, "dyn_obj/max_pixel_points", max_pixel_points, 50);
    DeclareAndGet<double>(node, "dyn_obj/frame_dur", frame_dur, 0.1);
    DeclareAndGet<int>(node, "dyn_obj/dataset", dataset, 0);
    DeclareAndGet<float>(node, "dyn_obj/self_x_f", self_x_f, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/self_x_b", self_x_b, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/self_y_l", self_y_l, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/self_y_r", self_y_r, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/blind_dis", blind_dis, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/fov_up", fov_up, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/fov_down", fov_down, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/fov_cut", fov_cut, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/fov_left", fov_left, 180.0f);
    DeclareAndGet<float>(node, "dyn_obj/fov_right", fov_right, -180.0f);
    DeclareAndGet<int>(node, "dyn_obj/checkneighbor_range", checkneighbor_range, 1);
    DeclareAndGet<bool>(node, "dyn_obj/stop_object_detect", stop_object_detect, false);
    DeclareAndGet<float>(node, "dyn_obj/depth_thr1", depth_thr1, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/enter_min_thr1", enter_min_thr1, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/enter_max_thr1", enter_max_thr1, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_depth_thr1", map_cons_depth_thr1, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_hor_thr1", map_cons_hor_thr1, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_ver_thr1", map_cons_ver_thr1, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_hor_dis1", map_cons_hor_dis1, 0.2f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_ver_dis1", map_cons_ver_dis1, 0.1f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_thr1", depth_cons_depth_thr1, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_max_thr1", depth_cons_depth_max_thr1, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_hor_thr1", depth_cons_hor_thr1, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_ver_thr1", depth_cons_ver_thr1, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/enlarge_z_thr1", enlarge_z_thr1, 0.05f);
    DeclareAndGet<float>(node, "dyn_obj/enlarge_angle", enlarge_angle, 2.0f);
    DeclareAndGet<float>(node, "dyn_obj/enlarge_depth", enlarge_depth, 3.0f);
    DeclareAndGet<int>(node, "dyn_obj/occluded_map_thr1", occluded_map_thr1, 3);
    DeclareAndGet<bool>(node, "dyn_obj/case1_interp_en", case1_interp_en, false);
    DeclareAndGet<float>(node, "dyn_obj/k_depth_min_thr1", k_depth_min_thr1, 0.0f);
    DeclareAndGet<float>(node, "dyn_obj/d_depth_min_thr1", d_depth_min_thr1, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/k_depth_max_thr1", k_depth_max_thr1, 0.0f);
    DeclareAndGet<float>(node, "dyn_obj/d_depth_max_thr1", d_depth_max_thr1, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/v_min_thr2", v_min_thr2, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/acc_thr2", acc_thr2, 1.0f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_depth_thr2", map_cons_depth_thr2, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_hor_thr2", map_cons_hor_thr2, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_ver_thr2", map_cons_ver_thr2, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/occ_depth_thr2", occ_depth_thr2, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/occ_hor_thr2", occ_hor_thr2, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/occ_ver_thr2", occ_ver_thr2, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_thr2", depth_cons_depth_thr2, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_max_thr2", depth_cons_depth_max_thr2, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_hor_thr2", depth_cons_hor_thr2, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_ver_thr2", depth_cons_ver_thr2, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/k_depth2", k_depth2, 0.005f);
    DeclareAndGet<int>(node, "dyn_obj/occluded_times_thr2", occluded_times_thr2, 3);
    DeclareAndGet<bool>(node, "dyn_obj/case2_interp_en", case2_interp_en, false);
    DeclareAndGet<float>(node, "dyn_obj/k_depth_max_thr2", k_depth_max_thr2, 0.0f);
    DeclareAndGet<float>(node, "dyn_obj/d_depth_max_thr2", d_depth_max_thr2, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/v_min_thr3", v_min_thr3, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/acc_thr3", acc_thr3, 1.0f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_depth_thr3", map_cons_depth_thr3, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_hor_thr3", map_cons_hor_thr3, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/map_cons_ver_thr3", map_cons_ver_thr3, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/occ_depth_thr3", occ_depth_thr3, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/occ_hor_thr3", occ_hor_thr3, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/occ_ver_thr3", occ_ver_thr3, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_thr3", depth_cons_depth_thr3, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_depth_max_thr3", depth_cons_depth_max_thr3, 0.5f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_hor_thr3", depth_cons_hor_thr3, 0.02f);
    DeclareAndGet<float>(node, "dyn_obj/depth_cons_ver_thr3", depth_cons_ver_thr3, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/k_depth3", k_depth3, 0.005f);
    DeclareAndGet<int>(node, "dyn_obj/occluding_times_thr3", occluding_times_thr3, 3);
    DeclareAndGet<bool>(node, "dyn_obj/case3_interp_en", case3_interp_en, false);
    DeclareAndGet<float>(node, "dyn_obj/k_depth_max_thr3", k_depth_max_thr3, 0.0f);
    DeclareAndGet<float>(node, "dyn_obj/d_depth_max_thr3", d_depth_max_thr3, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/interp_hor_thr", interp_hor_thr, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/interp_ver_thr", interp_ver_thr, 0.01f);
    DeclareAndGet<float>(node, "dyn_obj/interp_thr1", interp_thr1, 1.0f);
    DeclareAndGet<float>(node, "dyn_obj/interp_static_max", interp_static_max, 10.0f);
    DeclareAndGet<float>(node, "dyn_obj/interp_start_depth1", interp_start_depth1, 20.0f);
    DeclareAndGet<float>(node, "dyn_obj/interp_kp1", interp_kp1, 0.1f);
    DeclareAndGet<float>(node, "dyn_obj/interp_kd1", interp_kd1, 1.0f);
    DeclareAndGet<float>(node, "dyn_obj/interp_thr2", interp_thr2, 0.15f);
    DeclareAndGet<float>(node, "dyn_obj/interp_thr3", interp_thr3, 0.15f);
    DeclareAndGet<bool>(node, "dyn_obj/dyn_filter_en", dyn_filter_en, true);
    DeclareAndGet<bool>(node, "dyn_obj/debug_publish", debug_en, true);
    DeclareAndGet<int>(node, "dyn_obj/laserCloudSteadObj_accu_limit", laserCloudSteadObj_accu_limit, 5);
    DeclareAndGet<float>(node, "dyn_obj/voxel_filter_size", voxel_filter_size, 0.1f);
    DeclareAndGet<bool>(node, "dyn_obj/cluster_coupled", cluster_coupled, false);
    DeclareAndGet<bool>(node, "dyn_obj/cluster_future", cluster_future, false);
    DeclareAndGet<int>(node, "dyn_obj/cluster_extend_pixel", Cluster.cluster_extend_pixel, 2);
    DeclareAndGet<int>(node, "dyn_obj/cluster_min_pixel_number", Cluster.cluster_min_pixel_number, 4);
    DeclareAndGet<float>(node, "dyn_obj/cluster_thrustable_thresold", Cluster.thrustable_thresold, 0.3f);
    DeclareAndGet<float>(node, "dyn_obj/cluster_Voxel_revolusion", Cluster.Voxel_revolusion, 0.3f);
    DeclareAndGet<bool>(node, "dyn_obj/cluster_debug_en", Cluster.debug_en, false);
    DeclareAndGet<string>(node, "dyn_obj/cluster_out_file", Cluster.out_file, "");
    DeclareAndGet<float>(node, "dyn_obj/hor_resolution_max", hor_resolution_max, 0.0025f);
    DeclareAndGet<float>(node, "dyn_obj/ver_resolution_max", ver_resolution_max, 0.0025f);
    DeclareAndGet<float>(node, "dyn_obj/buffer_dur", buffer_dur, 0.1f);
    DeclareAndGet<int>(node, "dyn_obj/point_index", point_index, 0);
    DeclareAndGet<string>(node, "dyn_obj/frame_id", frame_id, "camera_init");
    DeclareAndGet<string>(node, "dyn_obj/time_file", time_file, "");
    DeclareAndGet<string>(node, "dyn_obj/time_breakdown_file",time_breakdown_file, "");
...
{
    const tbb::tick_count t00 = tbb::tick_count::now();
    ...
    tbb::parallel_for(size_t(0), index.size(), [&](size_t idx) {
        int i = index[idx];
        p[i].reset();     
    ...
    if(time_file != "") time_out << (tbb::tick_count::now() - t0).seconds() << " "; //rec computation time 
    for(int i = 0; i < size; i++)
    {
        PointType po;
    ...
    const tbb::tick_count clus_before = tbb::tick_count::now(); //rec computation time
    ...
    if(time_file != "") time_out << (tbb::tick_count::now() - clus_before).seconds() << " "; //rec computation time  
    const tbb::tick_count t3 = tbb::tick_count::now();
    Points2Buffer(points, index);
    if(time_file != "") time_out << (tbb::tick_count::now() - t3).seconds() << " "; //rec computation time
    Buffer2DepthMap(scan_end_time);
    if(time_file != "") time_out << (tbb::tick_count::now() - t3).seconds() << endl; //rec computation time
    if (cluster_coupled)
    {   
        for(int i = 0; i < size; i++)
        {
    ...
    if(is_rec) out.close();
    time_total = (tbb::tick_count::now() - t00).seconds();
    time_ind ++;
...
void DynObjFilter::publish_dyn(const rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr & pub_point_out,
