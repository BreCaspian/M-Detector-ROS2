...
int main(int argc, char** argv)
{
    ...
    dataset = node->declare_parameter<int>("dyn_obj/dataset", -1);
    is_origin = node->declare_parameter<bool>("dyn_obj/is_origin", false);
    dataset_folder = node->declare_parameter<string>("dyn_obj/dataset_folder", "/");
    start_param = node->declare_parameter<int>("dyn_obj/start_param", -1);
    end_param = node->declare_parameter<int>("dyn_obj/end_param", 0);
    start_se = node->declare_parameter<int>("dyn_obj/start_se", -1);
    end_se = node->declare_parameter<int>("dyn_obj/end_se", 0);
